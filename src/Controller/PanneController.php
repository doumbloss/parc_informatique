...
class PanneController extends AbstractController
{
    ...
    {
        // Log de consultation de la liste des pannes
    ...
    public function new(
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            try {
                ...
                $this->addFlash('error', 'Une erreur est survenue lors de la création de la panne.');
            }
        }
    ...
    {
        // Log de consultation d'une panne spécifique
        $this->loggerService->logActivity(
            ...
            [
                ...
                'panne_title' => $panne->getTitle() ?? 'Sans titre'
            ]
        );
    ...
    public function edit(
        ...
        $originalData = [
            'title' => $panne->getTitle(),
            'description' => $panne->getDescription(),
            'status' => $panne->getStatus(),
            'priority' => $panne->getPriority(),
        ];
    ...
    public function delete(
        ...
        if ($this->isCsrfTokenValid('delete' . $panne->getId(), $request->request->get('_token'))) {
            try {
                ...
                // Log de suppression (avant la suppression effective)
            ...
            // Log de tentative de suppression avec token CSRF invalide
    ...
    /**
     * Route pour afficher l'historique des logs d'une panne spécifique
     */
    #[Route('/{id}/logs', name: 'app_panne_logs', methods: ['GET'])]
    public function logs(Panne $panne): Response
    {
        // Récupération des logs liés à cette panne
